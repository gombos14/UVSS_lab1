...
public class Controller implements Initializable{
    ...
    public void loadQuestion() {
        ...
        answer1.setText(f.getFrage().get(questionNo).getAnswers().get(0).getText());
        answer2.setText(f.getFrage().get(questionNo).getAnswers().get(1).getText());
        try {
            answer3.setText(f.getFrage().get(questionNo).getAnswers().get(2).getText());
     ...
     */
    public Fragebogen generateFragebogen(int id) {
        List<Integer> l = generateRandomQuestions(1, 40);
        Fragebogen f = new Fragebogen(id);
        for(int x: l) {
    ...
    private boolean assertFirstAnswer() {
        ...
        boolean key = f.getFrage().get(questionNo).getAnswers().get(0).isCorrect();
    ...
    private boolean assertSecondAnswer() {
        ...
        boolean key = f.getFrage().get(questionNo).getAnswers().get(1).isCorrect();
        return ((selected && key) || (!selected && !key));
    }
    ...
    private boolean assertThirdAnswer() {
        ...
        boolean key = f.getFrage().get(questionNo).getAnswers().get(2).isCorrect();
        return ((selected && key) || (!selected && !key));
    }
